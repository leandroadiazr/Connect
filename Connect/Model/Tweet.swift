...
let tweetsData: [Tweet] = [Tweet(user: User(userID: UUID(), profileImage: Images.profilePic, name: "Leandro", handler: "@myhandler", email: "", password: nil, bio: "just a bio", location: "My location", feedID: UUID().uuidString, mainImage: Images.backMedia, otherImages: [Images.backMedia, Images.backMedia], status: "active", postedOn: Date(), postTitle: " A Title" , messageDescription: "Message ", likes: 100, comments: 20, views: 300), message: "This is a message sdfasd fas dfasdfa sdfas fasfas dfasdf asfa sdafa sdfas asdfasd fas dfasdfa sdfas fasfas dfasdf asfa sdafa sdfas asdfasd fas dfasdfa sdfas fasfas dfasdf asfa sdafa sdfas asdfasd fas dfasdfa sdfas fasfas dfasdf asfa sdafa sdfas asdfasd fas dfasdfa sdfas fasfas dfasdf asfa sdafa sdfas asdfasd fas dfasdfa sdfas fasfas dfasdf a]sfa sdafa sdfas")
